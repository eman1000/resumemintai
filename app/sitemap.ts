...
const STATIC_ROUTES: Entry[] = [
  ...
  { path: "/laid-off", changeFrequency: "weekly", priority: 0.9 },
  ...
  { path: "/extension", changeFrequency: "monthly", priority: 0.85 },
  { path: "/cover-letter-templates", changeFrequency: "weekly", priority: 0.8 },
  { path: "/extension/install", changeFrequency: "monthly", priority: 0.75 },
