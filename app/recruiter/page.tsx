    ...
    <>
      ...
      <header className="bg-[#0f1b2d]">
        <div className="max-w-site mx-auto px-4 py-20 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-blue-100/70">
            <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-blue-300" /> 14-day free trial</span>
            <span className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-blue-300" /> Evidence-based ranking</span>
            <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-blue-300" /> Cancel anytime</span>
          </div>
        </div>
      </header>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {steps.map((s) => (
              <div key={s.n} className="card text-center">
                <div className="w-12 h-12 rounded-full bg-blue-50 text-blue-700 font-bold text-xl flex items-center justify-center mx-auto">
                  {s.n}
                </div>
      ...
      <section className="bg-white">
        <div className="max-w-site mx-auto px-4 py-16">
          <div className="rounded-2xl bg-[#0f1b2d] px-6 py-12 md:px-12 text-center">
            ...
            <Link
              href="/recruiter/shortlist"
              className="inline-flex mt-6 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 text-base transition-colors"
            >
